...
using Application.Features.Operations.Commands.DeleteOperation;
...
public class OperationsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll([FromQuery] GetPaginatedOperationsRequest request, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ErrorResponse), (int) HttpStatusCode.NotFound)]
    [ProducesResponseType(typeof(ErrorResponse), (int) HttpStatusCode.BadRequest)]
    public async Task<IActionResult> Update(string id, [FromBody] PatchOperationRequest request, CancellationToken cancellationToken)
    {
        request.Id = id;
        var response = await _mediator.Send(request, cancellationToken);
        return Ok(response);
