...
[TestFixture]
public class PatchOperationTagTests : TestBase
{
    [Test]
    public async Task PatchOperationTag_WithValidRequest_Should_UpdateOperationTag()
    {
        // Arrange
        ...
        var request = new PatchOperationTagRequest
        {
    ...
    public async Task PatchOperationTag_WithWrongRequest_ShouldReturn_ErrorResponse(string name, string color)
    {
        // Arrange
        var dbContext = GetDbContext();
        var operationTag = new OperationTag
