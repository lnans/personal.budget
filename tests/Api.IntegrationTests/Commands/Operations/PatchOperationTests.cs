...
using Application.Features.Operations.Commands.PatchOperation;
using Domain.Common;
...
[TestFixture]
public class PatchOperationTests : TestBase
{
    [SetUp]
    ...
    [Test]
    public async Task PatchOperation_Should_UpdateOperationAndAccount_WithValidRequest()
    {
        // Arrange
        var request = new PatchOperationRequest
        {
            Id = OperationId, Description = "updated", TagId = null, Amount = 50, CreationDate = DateTime.Now, ExecutionDate = DateTime.Now
        };
    ...
    public async Task<HttpStatusCode> PatchOperation_ShouldReturn_ErrorResponse_WithWrongRequest(string description, string operationId, string tagId,
        decimal amount)
    {
        // Arrange
        var request = new PatchOperationRequest
        {
            Id = OperationId, Description = description, TagId = tagId, Amount = amount, CreationDate = DateTime.Now
        };
